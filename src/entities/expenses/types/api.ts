...
type UpdateExpenseApi = SetExpenseApi &
	Pick<ExpenseApiWithCategoryAndTags, "expenses_id">;
...
type GetTotalExpensesRequestParams = Omit<
...
type GetExpensesGroupByCategoryParams = Pick<
	GetExpenseRequestParams,
	"startDate" | "endDate"
>;
