...
const UiDatePicker = forwardRef<HTMLInputElement, DatePickerProps>((props, ref) => {
    ...
    return (
        <UiInput type='date' value={processedValue()} onChange={onDatePickerChange} {...rest} ref={ref}/>
    )
});
